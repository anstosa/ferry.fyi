...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    await queryInterface.createTable("AdCampaigns", {
    ...
    await queryInterface.addIndex("AdCampaigns", [
      "placementKey",
      "startsAt",
      "endsAt",
    ]);

    await queryInterface.createTable("AdPlacementDailyMetrics", {
      businessDate: {
        allowNull: false,
        primaryKey: true,
    ...
    await queryInterface.createTable("AdCampaignDailyMetrics", {
      businessDate: {
        allowNull: false,
        primaryKey: true,
        type: Sequelize.DATEONLY,
    ...
    await queryInterface.createTable("AdMeasurementExposures", {
      tokenHash: {
        allowNull: false,
        primaryKey: true,
    ...
    await queryInterface.createTable("AdReportShares", {
      id: { allowNull: false, primaryKey: true, type: Sequelize.UUID },
      campaignId: {
        allowNull: false,
        onDelete: "RESTRICT",
