// treat WSF as if it's an external module for typings
...
export namespace WSF {
  ...
  export interface TerminalVerboseResponse {
    TerminalID: number;
  ...
  export type RoutesResponse = RouteResponse[];
  ...
  export interface VesselsLocationResponse {
    VesselID: number;
    VesselName: string;
    Mmsi?: number;
    DepartingTerminalID: number;
  ...
  export interface VesselsVerboseResponse {
    VesselID: number;
