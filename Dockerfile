...
ARG REVENUECAT_ANDROID_PUBLIC_API_KEY
ARG REVENUECAT_IOS_PUBLIC_API_KEY
ARG REVENUECAT_WEB_PUBLIC_API_KEY
ARG SENTRY_DSN
ENV AUTH0_CLIENT_AUDIENCE=${AUTH0_CLIENT_AUDIENCE} \
    ...
    NODE_ENV=${NODE_ENV} \
    REVENUECAT_ANDROID_PUBLIC_API_KEY=${REVENUECAT_ANDROID_PUBLIC_API_KEY} \
    REVENUECAT_IOS_PUBLIC_API_KEY=${REVENUECAT_IOS_PUBLIC_API_KEY} \
    REVENUECAT_WEB_PUBLIC_API_KEY=${REVENUECAT_WEB_PUBLIC_API_KEY} \
