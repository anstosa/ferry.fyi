...
export default defineConfig({
  ...
  resolve: {
    ...
    alias: [
      ...
      {
        find: /^~\/lib\/(?!(?:accountDeletion$|admin(?:\/|$)|adOrigin$|alertMetadata$|auth0Admin$|auth0Config$|cameraDetectionCaptureRuns$|cameraFrames$|cameraLineDetection$|cancellationNotifications$|db$|delayNotifications$|demandCalendar$|demandEvents(?:\/|$)|errors$|fareCache$|fares$|firebase$|forecast(?:$|\/)|forecastDaypart$|forecastRegressionThresholds$|holidays$|httpApiPolicy$|httpCachePolicy$|httpSecurity$|httpTelemetry$|leaderboardAutomaticPolicy$|leaderboardFlags$|leaderboardPrivacy$|leaderboardSeo$|leaderboards$|logging$|noaaCoastline$|operationTelemetry$|ota$|push$|pushSubscriptions$|safeScheduledJob$|sailingLifecycleNotifications$|serverLifecycle$|serverRuntime$|tides(?:\/|$)|time$|weather(?:\/|$)|wsf(?:\/|$)))(.+)$/,
        replacement: path.resolve(__dirname, "client/lib/$1"),
      },
