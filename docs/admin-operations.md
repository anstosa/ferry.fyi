...
every tracked placement in a selected date range, including zero-opportunity
placements, and drills into weekday and hour-of-day totals. Weekday charts use
the complete daily history; hourly charts begin with the hourly-metrics
migration and do not reconstruct earlier hours
